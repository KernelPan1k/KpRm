...
impl SystemInfo {
    ...
    pub fn to_lines(&self) -> Vec<String> {
        vec![
            ...
            format!("Computer           : {}", self.computer_name),
            format!(
                "System             : {} ({}) - build {}",
                self.os_name,
            ...
            format!("Run count          : {}", self.pass_number),
        ]
    }
}
...
mod tests {
    ...
    fn formats_every_field() {
        ...
        assert!(lines
            .iter()
            .any(|l| l.contains("Run count") && l.contains('3')));
    }
    ...
    fn flags_32bit_machines() {
        ...
        assert!(info.to_lines().iter().any(|l| l.contains("32-bit")));
    }
}
