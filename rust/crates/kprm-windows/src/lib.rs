...
pub use locale::user_locale_name;
pub use process::WinProcessManager;
pub use quarantine_agent::{run_quarantine_cleanup, schedule_deferred_deletion};
pub use reboot::reboot_machine;
pub use registry::WinRegistry;
pub use report_io::write_and_open_report;
pub use restore::{list_registry_backups, schedule_registry_restore, RestoreOutcome};
